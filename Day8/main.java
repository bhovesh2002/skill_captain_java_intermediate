...
import static Day8.UserRegistrationExample.isValidEmail;
import static Day8.UserRegistrationExample.printMapValue;
    ...
    public static void main(String[] args) {
        ...
        while (i != EXIT){
            ...
            switch (i){
                ...
                case GET_ALL_USERS -> {
                    Map<Integer, User> allUsers = userRepository.getAllUsers();
